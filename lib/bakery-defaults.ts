...
export const DEFAULT_BAKERY_PRODUCTS: DefaultProduct[] = [
  ...
  { slug: 'brioche',             name: 'Brioche maison',         category: 'viennoiserie', price_cents:  320, emoji: '🧁', photo_url: null,                          sort_order: 13 },
  ...
  { slug: 'tarte_fruits',        name: 'Tarte aux fruits',       category: 'patisserie',   price_cents:  450, emoji: '🍓', photo_url: P('tarte_fruits.jpg'),         sort_order: 23 },
